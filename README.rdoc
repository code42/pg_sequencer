...
* :increment/:increment_by (numeric) - the value to increment the sequence by.
* :min - (numeric) - The minimum value of the sequence. If specified as false (e.g. :min => false), "NO MINVALUE" is sent to Postgres.
* :max - (numeric) - The maximum value of the sequence. May be specified as ":max => false" to generate "NO MAXVALUE"
* :start/:start_with - (numeric) - The starting value of the sequence (create_sequence only)
* :restart/:restart_with - (number) The value to restart the sequence with (change_sequence only)
* :cache - (numeric) - The number of values the sequence should cache.
* :cycle - (true/false) - Whether the sequence should cycle. Generated at "CYCLE" or "NO CYCLE"
